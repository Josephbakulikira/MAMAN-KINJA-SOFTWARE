...
function LoginPage() {
    ...
    const {setPending, pending, setUserInfo} = useIdeal()
    ...
    return (
        <div className='center-full-screen'>
            <form className="form_main" action="" onSubmit={login} autoComplete='off'>
            ...
            <button id='button' type="submit" disabled={pending}>Confirmer</button>
